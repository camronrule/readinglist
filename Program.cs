...
using VSreadinglist.Properties;
...
class Menu
{
    ...
    */
    ...
    class UserData : ApplicationSettingsBase
    {
        public UserData data;
        /*
         * Stores the user's readinglist in this program's properties file, only called on program closing
         */
        public void ClosingHandler(List<Book> list)
        {
            data.StoredBooks = list;
            data.Save();
        }


        /*
         * Retrieves stored user data from the properties file, only called on program open
         */
        public List<Book> OpeningHandler()
        {
            data = new UserData();
            return (data.StoredBooks);

        }


        [UserScopedSetting]
        public List<Book> StoredBooks
        {
            get
            {
                if (this["StoredBooks"] == null)
                {
                    this["StoredBooks"] = new List<Book>();
                }
                return ((List<Book>)this["StoredBooks"]);
            }
            set
            {
                this["StoredBooks"] = value;
            }
    ...
    class Program
    {
        ...
        static void Main() 
        {
            ...
            ReadingList.BookList = data.OpeningHandler();
            ...
            data.ClosingHandler(ReadingList.BookList);
        }
    }
